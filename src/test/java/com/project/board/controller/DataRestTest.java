...
@Disabled("String data rest 통합테스트 제외")
...
public class DataRestTest {
    ...
    @DisplayName("[api] get article comments list")
    @Test
    void givenNothing_whenRequestingArticleCommentsList_thenReturnsArticlesJsonResponse() throws Exception {
        // Given
    ...
    @DisplayName("[api] get article comment")
    @Test
